...
<html>
    <head>
        ...
        <title>Control Inventario - Ventas</title>
                            ...
                            <logic:notEmpty name="ActionFormVentas" property="listaVen">
                                <logic:iterate id="a" name="ActionFormVentas" property="listaVen">
                                    <tr>
                                        ...
                                        <td><button class="btn btn-outline-secondary btnArchivar" data-id="<bean:write name="a" property="idVenta"/>">Archivar</button></td>     
                                    </tr>
                                </logic:iterate>
                            </logic:notEmpty>
                        </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>¿Está seguro de archivar este registro de venta?</p>                            
                    </div>
