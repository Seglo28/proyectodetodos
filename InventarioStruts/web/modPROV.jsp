                            ...
                            <html:form action="/proveedores">
                                <div class="card">
                                    <div class="card bg-success text-white" >
                                        <div class="card-header">Ingresar sucursal</div>
                                    </div>
                                    <div class="card-body bg-light">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <div hidden="hidden"><html:text property="idProveedor"></html:text></div>
                                                    Proveedor:
                                                <html:text property="proveedor" size="50" maxlength="25"></html:text>
                                                    Rubro:
                                                <html:text property="rubro" size="50" maxlength="25"></html:text>
                                                    Contacto:
                                                <html:text property="contacto" size="50" maxlength="25"></html:text>
                                                    Teléfono:
