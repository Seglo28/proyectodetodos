                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label form="id_fabricante">Fabricante</label><br>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label form="Producto">Nombre del Producto</label><br>
                                    <html:text property="producto" styleClass="form-control"></html:text>
                                </div>
                            </div>   
                        <br>
