                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                            <html:form action="/sucursales"><br><br>
                            <div class="card">
                                <div class="card bg-success text-white" >
                                    <div class="card-header">Actualizar sucursal</div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <div hidden="hidden"><html:text property="idSucursal"></html:text></div>
                                            Sucursal:
                                            <html:text property="sucursal" size="50" maxlength="25"></html:text>
                                            Dirección:
                                            <html:text property="direccion" size="50" maxlength="25"></html:text>
                                            Municipio:
                                            <html:text property="municipio" size="50" maxlength="25"></html:text>
                                            Departamento:
                                            <html:text property="departamento" size="50" maxlength="25"></html:text>
                                            Telefono:
                                            <html:text property="telefono" size="50" maxlength="25"></html:text><br><br>
