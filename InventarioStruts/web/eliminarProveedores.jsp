           ...
           <html:form action="/proveedores">
            ...
            <table border="0" class="table-striped">
                <tbody style="margin: 5px;">
                    ...
                    <tr  style="padding: 10px;">
                        <td><html:text property="proveedor" size="120" maxlength="25"></html:text></td>
                    </tr>
                    <tr  style="padding: 10px;">
                        <td> Rubro:</td>     
                    </tr>
                    <tr  style="padding: 10px;">
                        <td><html:text property="rubro" size="120" maxlength="25"></html:text></td>
                    </tr>
                    <tr  style="padding: 10px;">
                        <td>Contacto:</td>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td><html:text property="contacto" size="120" maxlength="25"></html:text></td>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td>Teléfono:</td>
                    </tr>
