                          ...
                          <div class="card">
                            ...
                            <tbody style="margin: 5px;">
                                ...
                                <tr  style="padding: 10px;">
                                    <td>Cantidad: <br>
                                        <html:text property="cantidad" size="95" maxlength="10" value=""></html:text>
                                        </td>
                                    </tr>
                                    <tr  style="padding: 10px;">
                                    <td>Monto de la compra<br>
                                        <html:text property="monto" size="95" maxlength="" value=""></html:text>
                                        </td>
                                    </tr>
                                    <tr  style="padding: 10px;">
                                    <td>Fecha de la compra realizada: <br>
                                        <html:text property="fechaCompras" size="95" maxlength="25" value=""></html:text>
                                        </td>
                                    </tr>
