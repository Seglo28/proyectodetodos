                            ...
                            <div class="card-body bg-light">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <html:hidden property="idInventario"></html:hidden>
                                        <html:hidden property="idProducto"></html:hidden>
                                        <html:hidden property="cant"></html:hidden>

                                            <label>Stock Mínimo</label><br>
                                        <html:text property="stock" styleClass="form-control"></html:text>

                                        <html:hidden property="estado"></html:hidden>
                                        <html:hidden property="idProveedor"></html:hidden>
                                        <html:hidden property="idSucursal"></html:hidden>
                                        </div>
                                    </div>
                                <html:submit styleClass="btn btn-outline-success" property="action" value="Modificar">Modificar</html:submit>
