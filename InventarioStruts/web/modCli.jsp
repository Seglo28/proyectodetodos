            ...
            <div class="row">
                <div class="col-8">
                    <html:form action="/clientes">
                          <div hidden="hidden"><html:text property="idCliente"></html:text></div> 
                            ...
                            <tbody style="margin: 5px;">
                                ...
                                <tr  style="padding: 10px;">
                                    <td>Nombre del  cliente:
                                        <html:text property="cliente" size="70" maxlength="250"></html:text></td>     
                                    </tr>
                                    <tr  style="padding: 10px;">
                                    <td>Tipo de persona del cliente:
                                        <html:text property="tipoPersona" size="70" maxlength="250"></html:text></td>     
                                    </tr>
                                    <tr  style="padding: 10px;">
                                        <td>Direccion del Cliente
                                        <html:text property="direccion" size="70" maxlength="250"></html:text></td>
                                    </tr>
                                    <tr  style="padding: 10px;">
                                        <td>Telefono del Cliente
                                        <html:text property="telefono" size="70" maxlength="250"></html:text>
                                    </tr>
                                <br>
                                <tr colspan="2">
                                </tr><br>
