           ...
           <html:form action="/sucursales">
            ...
            <table border="0" class="table-striped">
                <tbody style="margin: 5px;">
                    ...
                    <tr  style="padding: 10px;">
                        <td><html:text property="sucursal" size="120" maxlength="25" value=""></html:text></td>
                    </tr>
                    <tr  style="padding: 10px;">
                        <td> Dirección:</td>     
                    </tr>
                    <tr  style="padding: 10px;">
                        <td><html:text property="direccion" size="120" maxlength="25" value=""></html:text></td>
                    </tr>
                    <tr  style="padding: 10px;">
                        <td>Municipio:</td>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td><html:text property="municipio" size="120" maxlength="25" value=""></html:text></td>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td>Departamento:</td>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td><html:text property="departamento" size="120" maxlength="25" value=""></html:text></td>
                    </tr>
                    </tr>
                     <tr  style="padding: 10px;">
                        <td>Telefono:</td>
                     ...
                     <tr  style="padding: 10px;">
                        <td><html:text property="telefono" size="120" maxlength="25" value=""></html:text></td>
                    </tr>
                <br>
                    <tr colspan="2">
