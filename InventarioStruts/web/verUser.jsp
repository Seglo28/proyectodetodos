...
<html>
   <head>
        ...
        <title>Control Inventario - Usuarios</title>
       ...
       <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-hover" id="table">
                            ...
                            <tbody>
                            <logic:notEmpty name="ActionFormUser" property="listaUser">
                                <logic:iterate id="user" name="ActionFormUser" property="listaUser">
                                    <tr>
                                        <html:form action="/user">
                                            <td><bean:write name="user" property="idUsuario"/>
                                                <div hidden="hidden"><html:text name="user" property="idUsuario" /></div>
                                            </td>
                                            <td><bean:write name="user" property="usuario"/></td>
        ...
        <script>
            ...
            $("#table").on("click", ".btnBorrar", function () {
                ...
                $("#modalDeleteFooter").append("<a class='btn btn-outline-danger' href='user.do?action=Borrar&idUsuario="+dataID+"'>Eliminar</a>");
