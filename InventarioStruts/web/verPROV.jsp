                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-hover" id="table">
                            ...
                            <tbody>
                            <logic:notEmpty name="ActionFormProveedores" property="listaPROV">
                                <logic:iterate id="proveedores" name="ActionFormProveedores" property="listaPROV">
                                    <tr>
                                        <html:form action="/proveedores">
                                            <td><bean:write name="proveedores" property="idProveedor"/>
                                                <div hidden="hidden"><html:text  name="proveedores" property="idProveedor"></html:text></div> </td>
                                            <td><bean:write name="proveedores" property="proveedor"/></td>
                                            <td><bean:write name="proveedores" property="rubro"/></td>
