...
<html>
    <head>
        ...
        <title>Control Inventario - Inventario</title>
                ...
                <div class="row">
                    <div class="col-12" id="aqui">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <logic:notEmpty name="ActionFormInventario" property="listaInv">
                                <logic:iterate id="ver" name="ActionFormInventario" property="listaInv">
                                    <tr>
                                        <html:form action="/inventario">
                                            <td><bean:write name="ver" property="idInventario"/></td>
                                    <div hidden="hidden"><html:text  name="ver" property="idInventario"></html:text></div> </td>
                                    <td><bean:write name="ver" property="productos.producto"/></td>
                                    <td><bean:write name="ver" property="cant"/></td>
                                    <td><bean:write name="ver" property="stock"/></td>
