            ...
            <div class="col-10">
                ...
                <div class="card">
                    <div class="card bg-info text-white">
                        <div class="card-header">Actualizar Compras</div>
                    </div>
                    <div class="card-body">
                        <div hidden="hidden"><html:text property="idCompra"></html:text></div> 
                            ...
                            Monto de la compra:<br>
                            <html:text property="monto" size="95" maxlength="" ></html:text>
                                                
                            Fecha de la compra realizada: <br>
